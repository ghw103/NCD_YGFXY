...
#define		AdminPassWord		"123456\0"								//¹ÜÀíÔ±ÃÜÂë£¬ÓÃÓÚĞŞ¸ÄÉè±¸id
#define		AdjustPassWord		"111111\0"								//Ğ£×¼ÃÜÂë
#define		TestPassWord		"222222\0"								//ÀÏ»¯²âÊÔÃÜÂë
#define		CheckQRPassWord		"333333\0"								//²âÊÔ¶şÎ¬ÂëÃÜÂë
#define		AdjLedPassWord		"444444\0"								//Ğ£×¼ledÃÜÂë
#define		FactoryResetPassWord	"555555\0"							//»Ö¸´³ö³§ÉèÖÃÃÜÂë
#define		ChangeValueShowTypePassWord	"666666\0"						//ÇĞ»»½á¹ûÏÔÊ¾Ä£Ê½£¬ÊÇ·ñÏÔÊ¾ÕæÊµÖµ
