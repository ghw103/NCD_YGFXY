...
#define		CheckQRPassWord		"333333"								//²âÊÔ¶şÎ¬ÂëÃÜÂë
#define		AdjLedPassWord		"444444"								//Ğ£×¼ledÃÜÂë
#define		FactoryResetPassWord	"555555"							//»Ö¸´³ö³§ÉèÖÃÃÜÂë
...
typedef struct ItemData_tag {
	...
	unsigned char varIcoIndex;														//ÅÅ¶Ó½çÃæÏÔÊ¾¿¨µÄÍ¼±ê½çÃæµÄË÷Òı
